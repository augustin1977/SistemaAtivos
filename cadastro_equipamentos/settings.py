...
INSTALLED_APPS = [
    ...
    "cadastro_equipamentos.apps.CoreProjectConfig",
    "djmoney",
    "equipamentos",
    "notas",
    "usuarios",
...
AMBIENTE_TESTE = ('servidor_teste' in str(BASE_DIR) or'ericaugustin' in str(BASE_DIR) or 'c:' in str(BASE_DIR) or 'servidor_teste' in str(BASE_DIR))
